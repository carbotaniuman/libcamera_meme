...
EGLint encodingFromColorspace(const libcamera::ColorSpace& colorSpace) {
    if (colorSpace.ycbcrEncoding == libcamera::ColorSpace::YcbcrEncoding::Rec2020) {
        return EGL_ITU_REC2020_EXT;
    } else if (colorSpace.ycbcrEncoding == libcamera::ColorSpace::YcbcrEncoding::Rec709) {
        return EGL_ITU_REC709_EXT;
    } else if (colorSpace.ycbcrEncoding == libcamera::ColorSpace::YcbcrEncoding::Rec601) {
